package com.metarealm.metarealm_be.security.auth.service;

import com.metarealm.metarealm_be.security.auth.model.DetailsUser;
import com.metarealm.metarealm_be.security.user.service.UserService;
...
public class DetailsService implements UserDetailsService {
    ...
    /**
     * 로그인 요청시 사용자의 id를 받아 DB 에서 사용자의 정보를 가져온다.
     *
